...
Thanks so much for joining me here. If you've got any questions, or if there's anything you'd like to see covered in a future edition of *AtRQ*, please let me know! Drop me an email (I'm david.lovell), or just come and say hi to me at my desk.
...
![](images/clipboard-4033239090.png "Arrested development is a really great show you should watch it."){fig-alt= "The scene from Arrested Development where he says 'hey, that's the name of the show', except I've made it say 'that's the name of the newsletter', pretty funny right?"}
...
![](images/clipboard-3914663401.jpeg){alt-text = "A picture of a hamster on a bicycle"}
