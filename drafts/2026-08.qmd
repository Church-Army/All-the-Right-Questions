...
flip_cards <- function(n_cards, n_tests, psychic_power = 0) {
  ...
  prob_exact <- 1/52 + psychic_power^2
  prob_just_suit <- 1/4 + psychic_power - prob_exact
  prob_just_rank <- 1/13 +psychic_power - prob_exact
...
highly_psychic_scores <- flip_cards(n_cards = 10, n_tests = 1e5, psychic_power = 0.3)
...
label_percent(0.1)(sum(scores >= 78) / length(scores))
